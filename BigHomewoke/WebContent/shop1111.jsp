	...
	<body>
			...
			<form action="${ctx }/findproduct/bigdelete" method="post">	
				<ul class="per_navul shop_carul">
					<li style="width: 130px;margin-right: 10px;">
						<input type="button" style="margin-right: 20px;" name="checkall" id="checkall" value="全选"/>
						全选
					</li>
		...
		<c:forEach items="${list }" var="p" varStatus="sta">
				...
				<table >
					<td name="tab">
					<li style="width: 130px;margin-right: 10px;">
						<input type="checkbox" name="tempString"  style="margin-right: 10px;margin-left: 18px;" value="${p.id }" />
					...
					<li>
						<input class="min" name="" type="button" value="-" style="width:20px;height:20px;"/> 
						<input class="text_box" name="" type="text" value="${p.count }" style="width:30px;height:20px;"/> 
						<input class="add" name="" type="button" value="+" style="width:20px;height:20px;"/> 	
					</li>
					<li>--</li>
